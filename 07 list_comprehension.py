...
# Given large number
large_number = input("Provide some number:")

# Using list comprehension to calculate the sum of digits
sum_of_digits = sum([int(digit) for digit in str(large_number)])
